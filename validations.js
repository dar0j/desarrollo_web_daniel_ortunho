/**
 * Módulo de validaciones para el formulario de actividades
 */
...
function validateForm() {
    ...
    // Validación de teléfono (opcional, pero si se proporciona debe tener el formato correcto)
